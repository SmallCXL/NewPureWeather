...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void initRecyclerView() {
        ...
        mAdapter = new TempWeatherAdapter(WeatherActivity.this,weatherInfos);
    ...
    private void showWeather() {
        ...
        if (weatherInfo != null) {
            MyImageLoader.load(WeatherActivity.this,
                    ImageCodeConverter.getMainBackgroundResource(weatherInfo.now.cond.code), toolbarBackground);
