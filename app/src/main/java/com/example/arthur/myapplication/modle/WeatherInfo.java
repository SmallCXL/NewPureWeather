...
public class WeatherInfo implements Serializable {
    ...
    public WeatherInfo() {
        ...
        this.now = new WeatherInfo.NowInfo();
        this.now.cond = new WeatherInfo.NowInfo.CondInfo();
        this.basic = new WeatherInfo.BasicInfo();
        this.basic.update = new WeatherInfo.BasicInfo.UpdateInfo();
